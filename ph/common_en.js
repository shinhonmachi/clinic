 ...
 * Sa pag-edit lang ng header_en.html / footer_en.html, maapektuhan
...
(async function () {
  ...
  if (headerEl) {
    try {
      ...
      console.error("Hindi ma-load ang header_en.html:", e);
    }
  }
  ...
  if (footerEl) {
    try {
      ...
      console.error("Hindi ma-load ang footer_en.html:", e);
    }
  }
