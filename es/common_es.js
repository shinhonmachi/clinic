...
(async function () {
  ...
  if (headerEl) {
    try {
      const res = await fetch("header_es.html");
      ...
      console.error("header_es.html の読み込みに失敗しました:", e);
    }
  }
  ...
  if (footerEl) {
    try {
      const res = await fetch("footer_es.html");
      footerEl.innerHTML = await res.text();
    } catch (e) {
      console.error("footer_es.html の読み込みに失敗しました:", e);
    }
  }
