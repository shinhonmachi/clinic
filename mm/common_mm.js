...
(async function () {
  ...
  if (headerEl) {
    try {
      const res = await fetch("header_mm.html");
      ...
      console.error("header_mm.html の読み込みに失敗しました:", e);
    }
  }
  ...
  if (footerEl) {
    try {
      const res = await fetch("footer_mm.html");
      footerEl.innerHTML = await res.text();
    } catch (e) {
      console.error("footer_mm.html の読み込みに失敗しました:", e);
    }
  }
