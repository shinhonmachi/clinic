...
(async function () {
  ...
  if (headerEl) {
    try {
      const res = await fetch("header_id.html");
      ...
      console.error("header_id.html の読み込みに失敗しました:", e);
    }
  }
  ...
  if (footerEl) {
    try {
      const res = await fetch("footer_id.html");
      footerEl.innerHTML = await res.text();
    } catch (e) {
      console.error("footer_id.html の読み込みに失敗しました:", e);
    }
  }
